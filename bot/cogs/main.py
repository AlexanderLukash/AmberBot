...
from bot.cogs.admin.stat import register_stat_admin_cogs
...
from bot.cogs.user.music import register_music_user_cogs
...
def register_all_cogs(bot: Bot) -> None:
    cogs = (
        ...
        register_stat_admin_cogs,
        register_music_user_cogs,
    )
    for cog in cogs:
        cog(bot)
